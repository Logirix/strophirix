...
Strophirix is a fork of Strophe.js (https://strophe.im/strophejs/) with changes on strophe.umd.js simply replacing the function that called setTimeout recursively for setInterval (it was causing Detox automated tests to get stuck waiting for the timeouts to finish)
